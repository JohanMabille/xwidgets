...
[![Binder](https://img.shields.io/badge/binder-launch-df8429.svg?logo=data:image/svg%2bxml;base64,)](https://mybinder.org/v2/gh/jupyter-xeus/xwidgets/stable?filepath=notebooks/xwidgets.ipynb)
...
|------------|----------------------|----------------------|----------------|----------------|-----------------|
|  main      | ^3.0.0               | ^4.0.0               | >=0.12.1,<0.13 | >=6.0,<7.0     | >=3.12.0,<3.13  |
|  0.30.0    | ^3.0.0               | ^4.0.0               | >=0.12.1,<0.13 | >=6.0,<7.0     | >=3.12.0,<3.13  |
|  0.29.3    | ^3.0.0               | ^4.0.0               | >=0.12.1,<0.13 | >=5.0,<6.0     | >=3.12.0,<3.13  |
